...
public class Common {
	 ...
	 * @return
	 */
	@RequestMapping("/getUserHabbit")
	public String getUserHabbit(HttpServletRequest request,Map<Object, Object> map,Map<Object, Object> map2) {
		//articleController.getUserHabbit(request.getParameter("bname"),map);
		List<Article> listArticle=(List<Article>) map.get("listArticle");
		System.out.println("123456:"+listArticle);
		int count=listArticle.size();
