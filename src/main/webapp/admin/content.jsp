		...
		<div class="row" style="margin-top: 70px">
			...
			<div class="  nav-left col-md-2 no-padding" id="nav-list-left">
				<div class="user-panel">
					<img src="${APP_PATH }/static/img/admin/login.jpg" class="img-circle center-block" />
				</div>
												...
												<c:if test="${!empty adminList}">
													...
													<c:if test="${listArticle.status==0 }">
														<form action="${APP_PATH}/articleController/articleStatus" method="post">
															...
															<input type="hidden" name="userid" value="${listArticle.userid }">
															<input type="hidden" name="titles" value="${listArticle.titles }">
